...
function quest1(arr) {
    const filteredArr = arr.filter(item => Number(item.unitPrice) > 30 && Number(item.unitPrice) < 100 )
...
function quest2(arr) {
    const filteredArr = arr.filter(item => item.name.substring(0,1).toLowerCase() === "a" )
...
function quest3(arr) {
    const filteredArr = arr.filter(item => item.name.substring((item.name.length - 1)).toLowerCase() === "a" )
...
function quest4(arr) {
    const findItem = arr.find(item => Number(item.id) === 10);
...
function quest5(arr) {
    const filteredArr = arr.filter(item => !item.discontinued);
